...
cd ../genus/aws/vh_auto/
sed -i "s:family_name:family_$family:g" config_vh.json
sed -i 's:/mnt/family_bam:/home/ec2-user/family_bam:g' config_vh.json

snakemake -j 8 -k -w 30 --rerun-incomplete
